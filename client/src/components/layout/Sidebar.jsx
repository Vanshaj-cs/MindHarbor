    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 py-5">
          ...
          <div>
            <h1 className="text-lg font-bold text-text-primary tracking-tight">MindSpace</h1>
            <p className="text-[10px] text-text-muted -mt-0.5">Your safe space</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4">
          <div className="gradient-mint rounded-2xl p-4">
            <p className="text-sm font-medium text-emerald-200">Need immediate help?</p>
